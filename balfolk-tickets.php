...
class BFT
{
	...
	private function __construct() {
		...
		self::loadClasses('includes', array('db-schema.php', 'events-tab.php', 'event-page.php', 'order.php', 'rest-orders-controller.php', 'rest-tickets-controller.php', 'rest-events-controller.php', 'rest-statistics-controller.php'));

...
= 1.2.5 =
* Options page for plugin created
* List of product IDs can be specified to enable optional checkbox on the checkout

= 1.2.4 =
* Statistics include only tickets for completed orders
